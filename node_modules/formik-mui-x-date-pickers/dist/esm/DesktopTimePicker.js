...
import { DesktopTimePicker as DesktopTimePicker$1 } from '@mui/x-date-pickers/DesktopTimePicker';
...
function DesktopTimePicker(_a) {
    ...
    return (React.createElement(DesktopTimePicker$1, __assign({}, fieldToDesktopTimePicker(props)), children));
}
DesktopTimePicker.displayName = 'FormikMUIDesktopTimePicker';

export { DesktopTimePicker, fieldToDesktopTimePicker };
