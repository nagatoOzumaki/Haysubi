...
import { MobileTimePicker as MobileTimePicker$1 } from '@mui/x-date-pickers/MobileTimePicker';
...
function MobileTimePicker(_a) {
    ...
    return (React.createElement(MobileTimePicker$1, __assign({}, fieldToMobileTimePicker(props)), children));
}
MobileTimePicker.displayName = 'FormikMUIMobileTimePicker';

export { MobileTimePicker, fieldToMobileTimePicker };
