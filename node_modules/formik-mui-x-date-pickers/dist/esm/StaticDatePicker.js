...
import { StaticDatePicker as StaticDatePicker$1 } from '@mui/x-date-pickers/StaticDatePicker';
...
function StaticDatePicker(props) {
    return React.createElement(StaticDatePicker$1, __assign({}, fieldToStaticDatePicker(props)));
}
StaticDatePicker.displayName = 'FormikMUIStaticDatePicker';

export { StaticDatePicker, fieldToStaticDatePicker };
