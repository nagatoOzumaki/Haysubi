...
import {
  ...
  reduceItemQuantity,
  addItemQuantity,
} from '../common/utils/hooks/useLocalStorage';
import { CartItem } from '../common/types/@appTypes';
import dynamic from 'next/dynamic';

const orderPlacedClip = '../public/vedios/order-placed-clip.mp4';
...
// dymaic import for localstorage ss
export default dynamic(() => Promise.resolve(CartPage), { ssr: false });

// ----------------------------------------------------------------------------------------

const CartDisplayProduct: FC<any> = (props) => {
